...
```bash
git clone https://github.com/Zteic/Aplikasi-Data-Mining-Hierarchical-Clustering-HAC-.git && cd Aplikasi-Data-Mining-Hierarchical-Clustering-HAC- && pip install -r requirements.txt && python -m streamlit run app.py
